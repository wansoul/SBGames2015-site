...
angular.module('sbgamesApp')
	.service('CulturaResultadosService', function CulturaResultadosService($http, $q){
		'use strict';
...
*/
		...
		$http.get('https://spreadsheets.google.com/feeds/list/1mqQXuRlN2rroUe_p7TvGUTcP6CnKrupKpr4rEDZQpuw/od6/public/values?alt=json')
		...
		$http.get('https://spreadsheets.google.com/feeds/list/1YRYjuql64qOxivEDX3Qh9s2zZ8-zfjiq2mbts0M_ht8/od6/public/values?alt=json')
		.success(function (data) {
			// console.log(data.feed.entry);
